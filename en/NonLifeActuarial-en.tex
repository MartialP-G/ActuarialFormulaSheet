...
\begin{itemize}
	\item Reserves for claims reported but not settled (RBNS).
...
%	\end{tikzpicture}
%\end{center}
%where \(\oslash\) désigne la division de Hamadard désigné par \(/\) en iml (ou division élément par élément de deux matrices).
%
