...
Dynamic, increasing (or decreasing) annuity \(Ia\) (\(Da\)): In its simplest form, it pays out an amount that starts at 1 (\(n\)) and increases (decreases) in each period arithmetically or geometrically until it reaches \(n\) (1). In the following example, the progression is arithmetic.
