...
\end{aligned}
\) & \(\displaystyle
\frac{\Gamma\!\left(\frac{k+1}{2}\right)}{\sqrt{k\pi}\,\Gamma\!\left(\frac{k}{2}\right)}
\left(1+\frac{x^2}{k}\right)^{-\frac{k+1}{2}}, x \in \mathbb{R}
\) & \(
\begin{aligned}
	& \mathbb{E}=0 \quad (k>1) \\
	& \operatorname{Var}=\dfrac{k}{k-2} \quad (k>2) \\
	& \gamma=0 \quad (k>3)
\end{aligned}
\) & \text{indéfinie}
\\
...
& \gamma=c^3+3 c \text { where } c^2=\operatorname{Var} / \mathbb{E}^2
\end{aligned}
\) }\\
\hline \(
\begin{aligned}
