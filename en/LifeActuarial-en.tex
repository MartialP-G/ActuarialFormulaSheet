...
\begin{f}[Simplified pricing schemes for periodic premiums and provisions]
...
\begin{tikzpicture}[node distance=35mm and 100mm]
	...
	\node (Prov) [startstop, below of=ppp] {Mathematical provision $t^e$ year\\ noted $PM_t$ or $V_t$};
