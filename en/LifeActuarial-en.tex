...
\begin{f}[Simplified pricing scheme for periodic premiums and reserves]
...
\begin{tikzpicture}[node distance=35mm and 100mm]
	...
	avec \(x,k,n,m,K...\)};
	\node (puu) [startstop, right of=pu, node distance=50mm] {Value of a unitary periodic premium\\ noted \(PPU_0\) or \(PV_P\)};
