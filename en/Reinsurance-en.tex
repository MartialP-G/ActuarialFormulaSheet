...
\begin{center}
		\resizebox{0.90\linewidth}{!}{\input{Graph/TypeAgreements-en}}
\end{center}
\end{f}
\hrule
...
The interlocking clause has the effect of recalculating the treaty limits, since a single event can simultaneously trigger the treaties for subscription years \(N\) and \(N-1\).
