...
\begin{center}
\input{ActuarialSciencesDiagram-fr}
\end{center}
\newpage
...
\href{https://scholar.google.com/citations?user=oZITlTQAAAAJ}{\color{OrangeProfondIRA}Marcelo Moreno Porras} 
\href{mailto:marcelo.moreno@urjc.es?subject=ActuarialFormSheet}{\color{OrangeProfondIRA}\faAt\ \faEnvelope} 
\href{https://www.linkedin.com/in/marcelomorenop/}{\color{OrangeProfondIRA}\faLinkedinSquare}
\href{https://orcid.org/0009-0007-1714-6507}{\tikz[scale=0.75, baseline=-1ex]{\fill[OrangeProfondIRA] (0, 0) circle (0.25); 
		\node[white,font=\sffamily\bfseries\scriptsize] at (0.175, -0.1) {ID};}}
\href{https://github.com/marcelomijas}{\color{OrangeProfondIRA} \large \faGithub} 
est Professeur associé à l’Université Rey Juan Carlos (Madrid) depuis 2023, spécialisé en économétrie, théorie macroéconomique et statistique appliquée. 
Il est également Développeur de logiciels et Spécialiste TI chez Navicopy Impresiones Digitales (Mijas, Espagne), où il développe des solutions en Python et SQL, la virtualisation et l’automatisation de bases de données.  
Marcelo enseigne l’économie monétaire et financière, la macroéconomie, la microéconomie appliquée, la politique économique et l’économie internationale, tant en espagnol qu’en anglais, au niveau licence et master. 
Il est l’auteur de plusieurs initiatives pédagogiques innovantes, et co-auteur de travaux sur l’intégration des Objectifs de Développement Durable (ODD) dans l’enseignement de l’économie. 
Sa formation académique comprend un Master en Analyse Économique Moderne (URJC), un Master en Statistique appliquée avec R (Université Nebrija), ainsi qu’une Licence en Économie (URJC).  
%
\end{tcolorbox}
\end{minipage}
    };
