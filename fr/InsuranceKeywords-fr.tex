...
\begin{itemize}
	\item Les \textbf{assurances vie}, c'est-à-dire les assurances de personnes à l'exception des assurances de dommages corporels,
...
L'assurance est supposée :
	...
	\end{itemize}
	\item établir le lien de causalité en Responsabilité Civile, "je ne suis pas responsable si je ne contribue pas à la cause du sinistre."
\end{f}
...
\begin{f}[La police d'assurance]
	...
	\begin{enumerate}
		...
		\end{itemize}
		\item  les obligations de la compagnie d'assurances : les délais de paiement pour l'indemnisation.
...
le dédommagement des sinistres sans excédents, ni bénéfices, globalement \(C= \mathbb{E}[S]\)
	...
	La \textbf{prime commerciale} est la prime nette + frais généraux + commissions + bénéfices escomptés + impôts.
	
	Pour des raisons commerciales, la prime effectivement demandée peut être très différente de la prime technique.

	\textbf{Prime émise:} prime demandée à l'assuré pour couvrir les sinistres qui peuvent survenir sur la
...
Le \(S/P\) est l'indicateur majeur. Pour que l'assureur ait un profit, il faut \(S/P\ll 1\). 
\end{f}
%\end{multicols}
...
\begin{f}[Triangle de charge / de paiement]
	...
	Chaque règlement, chaque provisionnement de sinistre est affecté à l'année de survenance. 
	...
	\left(\begin{array}{ccccc}
		...
		\rowcolor{white}	C_{2,1} & C_{1,2} & \ldots & C_{2, n-1} \\
...
\begin{f}[Solvabilité II et gestion des risques]
	...
	\begin{itemize}
		\item \textbf{Pilier 1 : Exigences quantitatives}  qui déterminent le capital minimum :\\
...
\begin{f}[Les principales branches de l’assurance vie et non-vie]
	...
	L’assurance non-vie couvre essentiellement des risques survenant à court ou moyen terme :
	\begin{itemize}[nosep]
		...
		\item \textbf{Pertes d’exploitation} : pertes financières d'une entreprise consécutives à un sinistre qui l'empêche d'exercer son activité.
