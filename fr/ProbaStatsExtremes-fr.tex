...
Si le taux de panne diminue au cours du temps alors, \(\alpha<1\). Si le taux de panne est constant dans le temps alors, \(\alpha=1\). Si le taux de panne augmente avec le temps alors, \(\alpha>1\). La compréhension du taux de panne peut fournir une indication au sujet de la cause des pannes.
...
La fonction de répartition de la \textbf{loi de Frechet}\index{D\'efinition! loi de Frechet} est donnée par 
\[
