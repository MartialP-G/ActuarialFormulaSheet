...
\begin{f}[Aversion au risque]
	Un agent est dit (strictement) \textbf{averse au risque} (ou risquophobe) si :
	\[
...
\textbf{Aléa moral :}
L'assuré réduit ou interrompt ses efforts maintenant qu'il est assuré. Les efforts de
\begin{itemize}
