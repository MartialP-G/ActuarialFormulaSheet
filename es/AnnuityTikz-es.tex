...
A
Anualidad dinámica, creciente (o decreciente) \(Ia\) (\(Da\)): en su forma más simple, se abona un importe que comienza en 1 (\(n\)) y que crece (o disminuye) en cada período de forma aritmética o geométrica hasta \(n\) (1). En el siguiente ejemplo, la progresión es aritmética.
