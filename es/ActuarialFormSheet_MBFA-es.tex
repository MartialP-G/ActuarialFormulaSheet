...
\usepackage{epsdice}
\usepackage{enumitem}
\setlist{before=\setstretch{.9}}
\usepackage{setspace}
\setstretch{0.95} % Réduit l'interligne de 5% globalement
%
...
\hypersetup{
	...
	pdfauthor   = {Martial Ph\'elipp\'e-Guinvarc'h and Marcelo Moreno Porras},
...
Mi Hoja de Referencia Actuarial\\\medskip\small
Máster en Economía de Seguros/Econometría\\
Master en Ciencias Actuariales}
\begin{document}
\maketitle
%
\newcounter{higher}\newcounter{rep} \setcounter{higher}{1}
\begin{center}
\input{ActuarialSciencesDiagram-es}
\end{center}
\newpage
...
\section*{Palabras Clave Seguros}
    \medskip
\end{center}
...
\input{InsuranceKeywords-es}
\end{multicols}

\newpage
\begin{center}
	\section*{Matemáticas Financieras}
	\medskip
\end{center}
...
\newpage
\begin{center}
\section*{Finanzas de Mercado}
    \medskip
\end{center}

\begin{multicols}{2}

\input{MarketFinance-es}
\end{multicols}

\newpage
\begin{center}
\section*{Ciencia Actuarial Vida}
    \medskip
\end{center}

\begin{multicols}{2}
	
\input{LifeActuarial-es}
\end{multicols}


\newpage
\begin{center}
    \section*{Probabilidad \& Estadística}
    \medskip
\end{center}
...
\newpage
\input{StatLawTable-es}

\newpage

\begin{center}
    \section*{(Micro)-Economía de los Seguros}
    \medskip
\end{center}
...
\newpage
\begin{center}
	\section*{Econometría \& Series Temporales}
	\medskip
\end{center}
...
\begin{center}
	\section*{Seguros de No Vida}
	\medskip
\end{center}

\begin{multicols}{2}	
	\input{NonLifeActuarial-es}
\end{multicols}
...
\begin{multicols}{2}	
	\input{Reinsurance-es}
\end{multicols}

\newpage
\begin{center}
	\section*{Estadísticas de extremos y precios de reaseguro}
	\medskip
\end{center}

\begin{multicols}{2}
	\input{ProbaStatsExtremes-es}
\end{multicols}

\newpage

\begin{center}
\section*{Recordatorio de matemáticas de secundaria/preparatoria}
\medskip
\end{center}

\begin{multicols}{2}	
\input{ElementaryFormulas-es}
\end{multicols}

\begin{center}
\medskip

	\section*{Mis notas personales}
	\medskip
\end{center}
...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=south east, xshift=-0.5cm, yshift=2cm,
    ...
    \begin{minipage}{\linewidth}
     \begin{tcolorbox}[beamerblock, title=Sobre los autores]
...
\href{https://github.com/MartialP-G}{\color{OrangeProfondIRA} \large \faGithub}  
	es actuario y profesor en la Universidad de Le Mans desde 2012 y también enseña en EURIA desde 2003. Es actuario (EURIA, 2006), miembro del Instituto de Actuarios (IA) y miembro de la Asociación Europea de Economistas Agrícolas (EAAE).

Martial Phélippé-Guinvarc'h imparte clases de estadística, análisis de datos, modelado actuarial, programación (en particular, en SAS y SAS IML), matemáticas financieras, mercados de materias primas, finanzas de mercado y derivados, ciencia actuarial de no vida, ciencia actuarial de vida, provisiones, solvencia, reaseguro, economía de seguros, gestión de riesgos y gestión de activos y pasivos. Es Protor de SAS y obtuvo el certificado SAS Join \href{https://www.sas.com/fr_fr/learn/academic-programs/specializations/programs.html}{Seguros y Análisis Económico} para el máster MBFA de la Universidad de Le Mans.
...
\href{https://orcid.org/0009-0007-1714-6507}{\tikz[scale=0.75, baseline=-1ex]{\fill[OrangeProfondIRA] (0, 0) circle (0.25); 
		\node[white,font=\sffamily\bfseries\scriptsize] at (0.175, -0.1) {ID};}}
\href{https://github.com/marcelomijas}{\color{OrangeProfondIRA} \large \faGithub} 
 es Profesor Asociado del Departamento de Economía Aplicada I e Historia e Instituciones Económicas de la Universidad Rey Juan Carlos (Madrid, España) desde 2023, especializado en econometría, macroeconomía y programación. También es Desarrollador de Software y Especialista en TI en una empresa privada de Mijas (España). Es autor de varias contribuciones a la innovación docente, coautor de publicaciones sobre la incorporación de los Objetivos de Desarrollo Sostenible en la formación económica y cuenta con experiencia técnica en diversos lenguajes de programación y herramientas estadísticas. Su formación académica incluye un Grado en Economía (URJC, entre el 1 \% ranking nacional), un Máster en Análisis Económico Moderno (URJC) y un Máster en Estadística Aplicada (Universidad Nebrija).%
\end{tcolorbox}
\end{minipage}
    };
\end{tikzpicture}
