...
Se asume que el seguro :
	...
	\end{itemize}
	\item establecer la relación de causalidad de un accidente en Responsabilidad Civil, quién no es responsable si no contribuye a la causa del accidente.
\end{f}
...
compensar las reclamaciones sin excedente ni beneficio, en general \(C = \mathbb{E}[S]\)
	...
	La \textbf{prima bruta} es la prima neta + gastos generales + comisiones + beneficios esperados + impuestos.
...
El \(S/P\) es el indicador principal. Para que la aseguradora obtenga beneficios, es necesario que \(S/P\ll 1\). 
\end{f}
%\end{multicols}
...
\begin{f}[Solvencia II y Gestión de Riesgos]
	...
	\begin{itemize}
		...
		Determinan los requisitos de capital :
		\begin{itemize}
...
\begin{f}[Principales ramas de seguros de vida y no vida]
	...
	El seguro de no vida cubre fundamentalmente los riesgos que se producen a corto o medio plazo. :
	\begin{itemize}[nosep]
